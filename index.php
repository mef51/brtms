...
<p>New this year for Battle Royale VI, we are trying a new tournaments mechanism: we have Major
Tournaments, and Crowdsourced Tournaments.</p>

<h2>Major Tournaments</h2>
<p style="margin-left:20px;">These are tournaments that the Battle Royale Organizing Committee will run.
...
you can do so at either of the IEEE offices at uOttawa or Carleton, and also at the event itself.</p>

<h2>Crowdsourced Tournaments</h2>
<p style="margin-left:20px;">These are tournaments that will be organized by players themselves.
...
These tournaments are free to join, no matter which ticket type you have purchased.
Initially, these tournaments will not have prizes provided by Battle Royale,
but prizes will be assigned to the popular tournaments.</p>

<p>To manage registrations to the tournaments, use the interface on the
<a href="${ROOT}/tournaments">Tournaments page</a> to make your selections.</p>'
, 'Home Dashboard');
